...
var FONT_SIZES = new Array("9pt", "13pt", "17pt", "15px");
...
function printStyle() {
	...
	res += '  .ngaythang {background-color:#FDFDF0;padding:3px 5px;}\n';
...
function showMonthSelect() {
	...
	//alertAbout();
	console.log("http://www.informatik.uni-leipzig.de/~duc/amlich/JavaScript/");
}
