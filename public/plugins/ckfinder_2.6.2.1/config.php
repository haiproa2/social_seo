...
function CheckAuthentication()
{
    ...
    return $_SESSION['ckfinder']['isLogged'];
    //return Auth::check();
}
...
*/
$baseUrl = 'http://truongtoc.com.vn/uploads/';
...
$config['AccessControl'][] = Array(
	...
	'folderView' => $_SESSION['ckfinder']['canView'],
	'folderCreate' => $_SESSION['ckfinder']['canCreate'],
	'folderRename' => $_SESSION['ckfinder']['canEdit'],
	'folderDelete' => $_SESSION['ckfinder']['canDelete'],

	'fileView' => $_SESSION['ckfinder']['canView'],
...
$config['plugin_imageresize']['largeThumb'] = '300x300';
$config['plugin_imageresize']['xlargeThumb'] = '480x480';
