<div class="leftpanel">
    ...
    <div class="logopanel">
    	<h1><a href="dashboard.html">{{ config('app.name', 'Laravel') }} <span>{{ config('app.version', 'v1.0') }}</span></a></h1>
    </div><!--logopanel-->
    
    <div class="datewidget">Today is {{ date('l, M d, Y H:j:s A', time()) }}</div>
    ...
    <div class="leftmenu">        
        <ul class="nav nav-tabs nav-stacked">
            ...
            <li class="active dropdown"><a href=""><span class="icon-pencil"></span> Forms</a>
