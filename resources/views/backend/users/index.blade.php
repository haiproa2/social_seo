							...
							<div class="row-fluid">
								<div class="span6">
									...
									<p class="row-fluid">
										...
										<span class="span8">{{ Form::text('birthday', $user->birthday, ['id'=>'birthday', 'class'=>'span12', 'readonly'=>true, 'title'=>'Click để chọn ngày', 'data-rel'=>'tooltip', 'data-placement'=>'top']) }}</span>
									</p>
									<p class="row-fluid">
