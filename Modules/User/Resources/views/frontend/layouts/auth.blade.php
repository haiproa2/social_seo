...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/katniss/css/style.default.css') }}" type="text/css" />
    <link rel="stylesheet" href="{{ asset('themes/katniss/css/style.custom.css') }}" type="text/css" />
